...
Browse local clothing assets, snap a chosen asset onto an animated body rig
via direct ``connectAttr`` only, and detach cleanly. Any rig can be registered
with the tool (see ``core/rigs.py``). See ``prd.md`` and
